        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Connecting authentic Kannauj artisans with fragrance lovers worldwide. Preserving 1000+ years of traditional Indian perfume-making heritage.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/shop" className="text-gray-300 hover:text-white transition-colors">Shop All Products</Link></li>
              <li><Link to="/artisans" className="text-gray-300 hover:text-white transition-colors">Meet Artisans</Link></li>
              <li><Link to="/b2b" className="text-gray-300 hover:text-white transition-colors">B2B Portal</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Attars (Ittar)</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Essential Oils</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Perfumed Soaps</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Incense & Dhoop</a></li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 AttarConnect. All rights reserved.
            </p>
