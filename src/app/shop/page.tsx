  ...
  const products = [
    {
      ...
      price: 2499,
      originalPrice: 2999,
      image: 'https://images.pexels.com/photos/4465124/pexels-photo-4465124.jpeg?auhref=compress&cs=tinysrgb&w=400',
      rating: 4.8,
      reviews: 127,
      category: 'Attars',
    ...
    },
    {
      ...
      price: 3799,
      originalPrice: 4299,
      image: 'https://images.pexels.com/photos/4041405/pexels-photo-4041405.jpeg?auhref=compress&cs=tinysrgb&w=400',
      rating: 4.9,
      reviews: 89,
    ...
    },
    {
      ...
      price: 299,
      originalPrice: 399,
      image: 'https://images.pexels.com/photos/4465831/pexels-photo-4465831.jpeg?auhref=compress&cs=tinysrgb&w=400',
      rating: 4.4,
      reviews: 342,
    ...
    },
    {
      ...
      price: 799,
      originalPrice: 999,
      image: 'https://images.pexels.com/photos/6303635/pexels-photo-6303635.jpeg?auhref=compress&cs=tinysrgb&w=400',
      rating: 4.8,
      reviews: 98,
                  ...
                  <div key={product.id} className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200 hover:shadow-lg transition-shadow duration-300 group">
                    ...
                    <div className="p-4">
                      <Link href={`/shop/${product.id}`}>
                        <h3 className="text-lg font-medium text-gray-900 mb-1 hover:text-amber-600 transition-colors">{product.name}</h3>
                      </Link>
                    ...
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          <div>
                            <Link href={`/shop/${product.id}`}>
                              <h3 className="text-xl font-medium text-gray-900 mb-1 hover:text-amber-600 transition-colors">{product.name}</h3>
                            </Link>
                            <p className="text-sm text-gray-600 mb-2">by {product.artisan}</p>
